...
Represents a location in the haunted house.

This class stores room descriptions, items, and exits. It relates to the

Game class by providing dynamic descriptions based on the current game state.
*/
public class Room {
private String name;
...
Constructs a Room with a name and a base description.

@param name the unique name of the room

@param description the default description of the room
*/
...
Adds an item to the room's collection.
...
// Manual loop required per AP CS A constraints
...
Adds an exit connection to another room.
...
Generates the room description based on the current game state.

@param game the Game instance to check state flags

@return the appropriate text description for the room
*/
...
Returns the list of exit strings.

@return the ArrayList of "Direction:Destination" strings
*/
